...
#check
med_diagnoses_reha_employ_QEB %>% select(pragmaid, date.treat.start, reha_id, treatment, QEB_count_before_reha, unpl_within_12m_before, unpl_drop) %>% arrange(pragmaid, date.treat.start)
table(med_diagnoses_reha_employ_QEB$QEB_count_before_reha)
...
table(med_diagnoses_reha_employ_QEB$unpl_within_12m_before)
```
...
reha_final <- med_diagnoses_reha_employ_QEB_SAB  %>% 
  select(-c(source, DIAG_STELLEN, DIAG_ALLES, DIAG_SEITE, DIAG_GRUPPE, DIAG_VERAEND, nationality, n.days, max_n_days, sab_unpl_before, DAUER_REHA, DIAG1, BEWILLDIAG, date.treat.start, date.treat.end, FAMILIE, ERWERB_V_ANTR, STELLUNG_BERUF, LEISTUNGSART, yob, ENTLASSFORM, date.emp.start, date.emp.end, id_pragma_reha, treatment))
...
predictors <- "sex + STAATS_ANGE + MASSN_ART + emp.type + unpl_within_12m_before + age + logageInt + reha_id + logreha_idInt + elix_sum + logelix_sumInt + ndistinctATClevel2 + logndistinctATClevel2Int + QEB_count_before_reha + logQEB_count_before_rehaInt + SAB_count_before_reha + logSAB_count_before_rehaInt"
...
vif_model <- glm(unpl_drop ~ sex + unpl_within_12m_before +age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent, data = reha_final, family = binomial)
car::vif(vif_model)
...
model12 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent + unpl_within_12m_before + (1|pragmaid), family = "binomial", data = reha_final) 
summary(model12)
...
```{r interactions}
model13 <- glmmTMB(unpl_drop ~ sex + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ age_cent*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final) 
summary(model13)
add_model_summary(model13, "Model 13") 

model14 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ sex*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final) 
summary(model14)
add_model_summary(model14, "Model 14")

model15 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ STAATS_ANGE*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final) 
summary(model15)
add_model_summary(model15, "Model 15")

model16 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ emp.type*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final) 
summary(model16) 
...
model18 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ elix_sum_cent*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final) 
summary(model18) 
add_model_summary(model18, "Model 18")

model19 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ ndistinctATClevel2_cent*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final) 
summary(model19) 
add_model_summary(model19, "Model 19")

model20 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ MASSN_ART*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final)
summary(model20)
add_model_summary(model20, "Model 20")

model21 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ QEB_count_before_reha_cent*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final)
summary(model21) 
add_model_summary(model21, "Model 21")

model22 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent +unpl_within_12m_before+ SAB_count_before_reha_cent*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final)
summary(model22) 
add_model_summary(model22, "Model 22")

model23 <- glmmTMB(unpl_drop ~ sex + age_cent + reha_id_cent + STAATS_ANGE + emp.type + elix_sum_cent + ndistinctATClevel2_cent + MASSN_ART + QEB_count_before_reha_cent + SAB_count_before_reha_cent + SAB_count_before_reha_cent + unpl_within_12m_before*reha_id_cent + (1|pragmaid), family = 
                     "binomial", data = reha_final)
summary(model22) 
add_model_summary(model22, "Model 22")
```
