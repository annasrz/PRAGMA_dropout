...
reha_final$logQWT_count_before_rehaInt <- log(reha_final$QWT_count_before_reha+1) * reha_final$QWT_count_before_reha
reha_final$logINPAT_count_before_rehaInt <- log(reha_final$INPAT_count_before_reha+1) * reha_final$INPAT_count_before_reha
...
predictors <- "sex + STAATS_ANGE + MASSN_ART + emp.type + age + logageInt + reha_id + logreha_idInt + elix_sum + logelix_sumInt + ndistinctATClevel2 + logndistinctATClevel2Int + QWT_count_before_reha + logQWT_count_before_rehaInt + INPAT_count_before_reha + logINPAT_count_before_rehaInt"
...
-> keine Verletzungen der Linearitätsannahme
...
new_labels <- c(
  ...
  "INPAT_count_before_reha_cent" = "Behandlungserfahrung SAB",
