...
new_labels <- c(
  ...
  "n_QEB_abgebrochen_cent" = "vorh. irr. QEB (Anzahl, kont.)",
  "n_SAB_abgebrochen_cent" = "vorh. irr. SAB (Anzahl, kont.)",
  "n_REHA_regulaer_cent" = "vorh. reg. REHA (Anzahl, kont.)",
  "n_QEB_regulaer_cent" = "vorh. reg. QEB (Anzahl, kont.)",
...
#save as tif
ggsave(file.path(folder_plot, "coefffix_plot_REHA.tif"), coefffix_plot, width = 8, height = 6.5, dpi = 600, bg = "white")
# 
