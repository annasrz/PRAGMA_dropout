...
# clean workspace
rm(list=ls())
packages <- c("data.table", "tidyverse", "ggplot2", "glmmTMB", "comorbidity", "car", "lme4", "ordinal", "export")
...
#AIC 3762
#AIC with non dichotomized nATCs 3763, 3763.8 with dichotomized nATCs in polymedi (5 or more ATCs is better than 6 or more)
#Verleich 180 Tage Look back window und 90 Tage und 364: 180 Tage hat besseres AIC (3783.3 vs. 3784.3 vs. 3784.2)


# modelfit verbessert sich leicht, wenn ich keinen random intercept für gkv verwende

#wenn polymedi mit rein genommen wird, dann wird BIC größer und p-Wert von elix_sum größer (war allerdings vorher schon nicht signifikant)

#check significance of random effects
plot(residuals(model1)) # 0.33 -> random effects are significant
```
