...
new_labels <- c(
  "(Intercept)" = "Intercept", 
  "age_cent" = "Alter",
  "n_SAB_abgebrochen_cat2+" = "vorherige irregulär beendete SAB: 2+ (Ref.: 0)",
  "n_SAB_abgebrochen_cat1" = "vorherige irregulär beendete SAB: 1 (Ref.: 0)",
  "n_QEB_abgebrochen_cat1" = "vorherige irregulär beendete QEB: 1 (Ref.: 0)",
  "n_QEB_abgebrochen_cat2+" = "vorherige irregulär beendete QEB: 2+ (Ref.: 0)",
  "n_QEB_reg_cat1-2" = "vorherige regulär beendete QEB: 1-2 (Ref.: 0)",
  "n_QEB_reg_cat3+" = "vorherige regulär beendete QEB: 3+ (Ref.: 0)",
 ...
 # "QEB_id_cent" = "Behandlungserfahrung QEB",
  ...
  "nationalitynicht deutsch" = "Nationalität: deutsch (Ref.: nicht deutsch)",
  ...
  "emp.typeretired" = "Beschäftigungsstatus: Rente (Ref.: erwerbstätig)",
  "elix_sum_cent" = "Elixhauser-Score",
  "fost.degree_binnein" = "Pflegestatus: nicht vorhanden (Ref.: vorhanden)",
...
#save as tif
ggsave(file.path(folder_plot, "coefffix_plot_QEB.tif"), coefffix_plot, 
       width = 175,
       height = 142, 
       units = "mm",
       dpi = 500,
