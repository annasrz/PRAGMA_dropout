...
table(qwt$direkter_anschluss, useNA = "always") #6 with direkter anschluss
...
missing_rows <- total_stamm %>%
  anti_join(total_employ, by = c("pragmaid", "date.qwt.start", "date.qwt.end")) #für 41 Zeilen gibt es keine employment Daten (-> Lücken in den Daten, siehe unten), diese werden zT exkludiert (aktiver Versichertenstatus ist Inklusionskriterium)
