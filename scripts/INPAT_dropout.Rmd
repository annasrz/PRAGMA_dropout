...
new_labels <- c(
  "(Intercept)" = "Intercept", 
  "age_cent" = "Alter",
  "inpat_id_cent" = "Behandlungserfahrung INPAT",
...
# not necessary as the DHARMa residual plot (Residualwerte (y-Achse) gegen die vorhergesagten Werte (x-Achse)) looks fine
```
