...
#remove them. definition outlier: n.days bigger than 75% quantile + 3*IQR (Tukey's fences)
...
#- Test this!
#- One way to test this is to plot the predicted probabilities against the independent variables. If the relationship is linear, the predicted probabilities should be linearly related to the independent variables.
#- Another way to test this is to plot the residuals against the predicted probabilities. If the relationship is linear, the residuals should be randomly scattered around zero for all predicted probabilities.
...
choose_best_model(model_summaries, "Deviance") #Model 8 hat den besten fit
