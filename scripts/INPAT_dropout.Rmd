...
```
Ergebnisse aus Model 8:

- Personen in Rente haben eine erhöhte Wahrscheinlichkeit für einen nur 1-6 tägigen Aufenthalt. 
- Ältere Personen hingegen haben eine erhöhte Wahrscheinlichkeit für einen längeren Aufenthalt (sowohl 7-20, als auch 21+ Tage)
- Personen mit höherm Elixhauser Scores haben eine erhöhte Wahrscheinlichkeit für einen längeren Aufenthalt (sowohl 7-20, als auch 21+ Tage)
- je mehr inpatient treatments eine Person hatte, desto niedriger die Wahrscheinlichkeit für einen längeren Aufenthalt (nur 1-6 vs 21+ Tage signifikant)
...
final_data_cont <- final_data %>% ungroup() %>% select_if(is.numeric) %>% select(-(c(treat_dur_cat_num, n.days, ndistinctATC, char_sum)))
