...
```{r correlation}
cor_matrix <-  cor(final_data %>% select(c("age_cent", "SAB_id_cent", "elix_sum_cent", "ndistinctATClevel2_cent", "QEB_count_before_SAB_cent", "REHA_count_before_SAB_cent")))
cor_matrix
...
model12 <- glmmTMB(unpl_drop ~ sex + age_cent + SAB_id_cent+ nationality + emp.type + elix_sum_cent + fost.degree_bin + ndistinctATClevel2_cent + QEB_count_before_SAB_cent + REHA_count_before_SAB_cent + (1|pragmaid), family = "binomial", data = final_data) 
summary(model12)
